...
export function ProfileView({
  ...
  const socialLinks = [
    { key: 'location' as keyof ShelterProfileForm, icon: <MapPin size={16} />, label: 'Ubicación', href: profileForm.location ? `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(profileForm.location)}` : null },
    { key: 'instagram' as keyof ShelterProfileForm, icon: <InstagramLogo size={16} />, label: 'Instagram', href: profileForm.instagram || null },
    { key: 'facebook' as keyof ShelterProfileForm, icon: <FacebookLogo size={16} />, label: 'Facebook', href: profileForm.facebook || null },
    { key: 'youtube' as keyof ShelterProfileForm, icon: <YoutubeLogo size={16} />, label: 'YouTube', href: profileForm.youtube || null },
    { key: 'tiktok' as keyof ShelterProfileForm, icon: <TiktokLogo size={16} />, label: 'TikTok', href: profileForm.tiktok || null },
    { key: 'website' as keyof ShelterProfileForm, icon: <Globe size={16} />, label: 'Web', href: profileForm.website || null },
  ];
              ...
              <div className="-mt-12 mb-5">
                <div className="w-24 h-24 rounded-full border-4 border-surface dark:border-slate-800 bg-background dark:bg-slate-900 overflow-hidden flex items-center justify-center shadow-sm">
                  {profileForm.avatarUrl ? (
                    ...
                    <Building size={36} weight="fill" className="text-ink-light dark:text-slate-500" />
                  )}
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Cuenta brevemente la misión del refugio..."

...
export function ProfileView({
  ...
  const socialLinks = [
    { key: 'location' as keyof ShelterProfileForm, icon: <MapPin size={18} className="text-brand-500" />, label: 'Ubicación', value: profileForm.location, href: profileForm.location ? `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(profileForm.location)}` : null },
    { key: 'instagram' as keyof ShelterProfileForm, icon: <InstagramLogo size={20} />, label: 'Instagram', value: profileForm.instagram, href: profileForm.instagram || null, color: 'hover:text-pink-600 hover:border-pink-500/30' },
    { key: 'facebook' as keyof ShelterProfileForm, icon: <FacebookLogo size={20} />, label: 'Facebook', value: profileForm.facebook, href: profileForm.facebook || null, color: 'hover:text-blue-600 hover:border-blue-500/30' },
    { key: 'youtube' as keyof ShelterProfileForm, icon: <YoutubeLogo size={20} />, label: 'YouTube', value: profileForm.youtube, href: profileForm.youtube || null, color: 'hover:text-red-600 hover:border-red-500/30' },
    { key: 'tiktok' as keyof ShelterProfileForm, icon: <TiktokLogo size={20} />, label: 'TikTok', value: profileForm.tiktok, href: profileForm.tiktok || null, color: 'hover:text-black hover:border-black/30 dark:hover:text-white dark:hover:border-white/30' },
    { key: 'website' as keyof ShelterProfileForm, icon: <Globe size={20} />, label: 'Sitio Web', value: profileForm.website, href: profileForm.website || null, color: 'hover:text-brand-500 hover:border-brand-500/30' },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="https://instagram.com/mi_refugio"
                className={inputClass}
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="https://tiktok.com/@mi_refugio"
                className={inputClass}
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="https://facebook.com/mi_refugio"
                className={inputClass}
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="https://youtube.com/c/mi_refugio"
                className={inputClass}
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end gap-6 -mt-20 md:-mt-24">
            <div className="w-36 h-36 md:w-44 md:h-44 rounded-full border-4 border-white dark:border-slate-800 bg-background dark:bg-slate-900 overflow-hidden flex items-center justify-center shadow-xl shrink-0 z-10">
              {profileForm.avatarUrl ? (
                ...
                <Building size={64} className="text-ink-light dark:text-slate-500" />
              )}
            </div>
            ...
            {profileForm.description ? (
              ...
              <div className="py-10 text-center">
                ...
                <p className="text-ink-light dark:text-slate-500 italic text-sm">
                  Aún no has añadido una descripción sobre tu refugio. ¡Haz clic en "Editar Perfil" para contar tu historia y misión!
                </p>
              </div>
            )}
          </div>
